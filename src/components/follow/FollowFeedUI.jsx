...
const FeedHeader = ({ postsCount = 0, onRefresh = null }) => (
  <div className="mb-8 relative">
    ...
    <div className="absolute inset-0 overflow-hidden">
      <div className="absolute top-0 right-0 w-40 h-40 bg-gradient-to-br from-purple-1 to-purple-2 rounded-full opacity-20 animate-pulse"></div>
      <div className="absolute top-4 left-8 w-20 h-20 bg-gradient-to-br from-purple-1 to-purple-2 rounded-full opacity-30 animate-bounce"></div>
    </div>

    <div className="relative z-10 flex items-center justify-between">
      <div className="flex items-center gap-4 md:gap-6">
        <div className="relative">
          <div className="w-12 h-12 md:w-16 md:h-16 bg-gradient-to-br from-purple-5 to-purple-7 rounded-3xl flex items-center justify-center shadow-lg animate-pulse">
            <svg className="w-6 h-6 md:w-8 md:h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6h16M4 10h16M4 14h16M4 18h16" />
            </svg>
          </div>
          {/* Floating notification dot */}
          <div className="absolute -top-1 -right-1 w-3 h-3 md:w-4 md:h-4 bg-gradient-to-r from-pink-4 to-pink-5 rounded-full animate-ping"></div>
        </div>
        <div>
          <h2 className="text-2xl md:text-4xl font-bold bg-gradient-to-r from-purple-6 via-purple-7 to-pink-6 bg-clip-text text-transparent mb-2 animate-pulse">
            Your Feed ✨
          </h2>
      ...
      <div className="flex items-center gap-2 md:gap-3">
        ...
        <button
          onClick={onRefresh}
          className="group relative p-3 md:p-4 rounded-2xl bg-gradient-to-br from-purple-1 to-purple-1 hover:from-purple-1 hover:to-purple-2 transition-all duration-300 hover:scale-105 shadow-lg border border-purple-2"
          title="Refresh feed"
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-purple-2 to-purple-3 rounded-2xl opacity-0 group-hover:opacity-20 transition-opacity duration-300"></div>
        </button>
      </div>
    </div>
  </div>
...
const TimelinePost = React.memo(({ post, index, totalPosts, onClick }) => (
  <div className="relative">
    {/* Timeline line */}
    {index < totalPosts - 1 && (
      <div className="absolute left-0 top-20 w-0.5 h-full to-transparent"></div>
    )}
...
const LoadMoreButton = ({ isLoading, onLoadMore }) => (
  <div className="text-center mt-16 relative">
    {/* Decorative line */}
    <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-px h-8 bg-gradient-to-b from-purple-3 to-transparent"></div>
      ...
      >
        {isLoading ? (
          ...
          <>
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-purple-7 to-purple-8 rounded-3xl opacity-0 group-hover:opacity-20 transition-opacity duration-300"></div>
          </>
        )}
      </button>
...
const PaginationInfo = ({ currentCount, total }) => (
  <div className="text-center mt-8">
    <div className="inline-flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-purple-1 to-pink-1 rounded-2xl text-sm font-medium text-purple-7 border border-purple-2 shadow-lg">
...
const ErrorState = ({ error, onRefresh }) => (
  <div className="text-center py-16">
    ...
    <button
      onClick={onRefresh}
      className="inline-flex items-center gap-3 bg-gradient-to-r from-red-5 to-red-6 text-white px-8 py-4 rounded-2xl font-medium hover:from-red-6 hover:to-red-7 transition-all duration-300 hover:scale-105 hover:shadow-xl"
    >
  ...
  <div className="relative">
    <div className="relative z-10 text-center py-20">
      ...
      <div className="relative mb-8">
        <div className="w-32 h-32 bg-gradient-to-br from-purple-1 via-purple-2 to-purple-2 rounded-full flex items-center justify-center mx-auto mb-4 shadow-2xl">
      ...
      <div className="max-w-2xl mx-auto">
        <h3 className="text-4xl font-bold bg-gradient-to-r from-blue-6 via-blue-7 to-purple-6 bg-clip-text text-transparent mb-4">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <button
            ...
            className="group relative inline-flex items-center gap-3 bg-gradient-to-r from-blue-6 to-blue-7 text-white px-8 py-4 rounded-2xl font-bold hover:from-blue-7 hover:to-blue-8 transition-all duration-300 hover:scale-105 hover:shadow-2xl"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
            </svg>
...
const EmptyNoFollows = ({ onSwitchToAllPosts, onRefresh }) => (
  <div className="relative">
    {/* Background decorative elements */}
    <div className="absolute inset-0 overflow-hidden">
      <div className="absolute top-10 left-10 w-32 h-32 bg-gradient-to-br from-purple-1 to-purple-2 rounded-full opacity-20 animate-pulse"></div>
      <div className="absolute top-32 right-20 w-24 h-24 bg-gradient-to-br from-purple-1 to-purple-2 rounded-full opacity-30 animate-bounce"></div>
      <div className="absolute bottom-20 left-1/4 w-16 h-16 bg-gradient-to-br from-pink-1 to-pink-2 rounded-full opacity-25 animate-pulse"></div>
    </div>

    <div className="relative z-10 text-center py-20">
      {/* Animated Icon */}
      <div className="relative mb-8">
        <div className="w-32 h-32 bg-gradient-to-br from-purple-1 via-purple-2 to-purple-3 rounded-full flex items-center justify-center mx-auto mb-4 animate-pulse shadow-2xl">
      ...
      {/* Engaging Content */}
      <div className="max-w-2xl mx-auto">
        <h3 className="text-4xl font-bold bg-gradient-to-r from-purple-6 via-purple-7 to-pink-6 bg-clip-text text-transparent mb-4 animate-pulse">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 border border-purple-1">
            <div className="w-12 h-12 bg-gradient-to-br from-blue-5 to-blue-7 rounded-xl flex items-center justify-center mb-4 mx-auto">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 border border-purple-1">
            <div className="w-12 h-12 bg-gradient-to-br from-emerald-5 to-emerald-6 rounded-xl flex items-center justify-center mb-4 mx-auto">
              <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
              </svg>
            </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <button
            onClick={onSwitchToAllPosts}
            className="group relative inline-flex items-center gap-3 bg-gradient-to-r from-purple-6 to-purple-7 text-white px-8 py-4 rounded-2xl font-bold hover:from-purple-7 hover:to-purple-8 transition-all duration-300 hover:scale-105 hover:shadow-2xl"
          >
            <svg className="w-5 h-5 group-hover:rotate-12 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
            </svg>
            Explore Epic Adventures
            <div className="absolute inset-0 bg-gradient-to-r from-purple-7 to-purple-8 rounded-2xl opacity-0 group-hover:opacity-20 transition-opacity duration-300"></div>
          </button>
        ...
        {/* Fun Stats or Tips */}
        <div className="mt-8 bg-gradient-to-r from-purple-1 to-pink-1 rounded-2xl p-6 border border-gray-1">
